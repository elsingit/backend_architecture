...
This repository is the home for all of your group's code and documentation during this project. Some folders and (empty) files have been added as a starting point, but you may choose to replace them.
...
Description of the technologies used in the system (Node, RabbitMQ, WebSocket, ...), how the technologies were used in the project, and the group's view of the technologies from your use. Could other/better alternatives have been used? Or is there an alternative that would have been more interesting to the group?
